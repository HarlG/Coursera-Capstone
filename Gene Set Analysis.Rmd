...
odds_ratio = function(H3K4, prom, all.prom) {
  ...
  OR = (om[1,1]*om[2,2])/(om[1,2]*om[2,1])
  om = round(om / 10^6, 2)
  return(OR)
}
```
...
```{r}
ORMat[1,1] = odds_ratio(fetal.H3K4.gr, fetal.prom, all.prom)
ORMat[1,2] = odds_ratio(fetal.H3K4.gr, adult.prom, all.prom)
ORMat[2,1] = odds_ratio(adult.H3K4.gr, fetal.prom, all.prom)
ORMat[2,2] = odds_ratio(adult.H3K4.gr, adult.prom, all.prom)
ORMat[3,1] = odds_ratio(liver.H3K4.gr, fetal.prom, all.prom)
ORMat[3,2] = odds_ratio(liver.H3K4.gr, adult.prom, all.prom)
ORMat
```
